...
function themeConfig($form) {
    ...
    $bgimg = new Typecho_Widget_Helper_Form_Element_Text('bgimg', NULL, NULL, _t('背景图片URL'), _t('您甚至可以插入BING随机壁纸：https://img.hostn.cn'));
    $form->addInput($bgimg);

    $topimg = new Typecho_Widget_Helper_Form_Element_Text('topimg', NULL, NULL, _t('顶部图片URL'), _t('在这里填入一个图片URL'));
    $form->addInput($topimg);

    $selfidt = new Typecho_Widget_Helper_Form_Element_Textarea('selfidt', NULL, NULL, _t('侧栏个人介绍'), _t('在这里填入HTML代码，每一行用一个&lt;li&gt;标签，支持font-awesome，<b onclick=\'$("#vblogshowcode0").slideToggle(500)\'>点我查看示例。</b><textarea id="vblogshowcode0" style="display:none;"><li><i class="fa fa-thumbs-up"></i> 略略略略略略~ (๑•̀ㅂ•́)و✧</li>
<li><i class="fa fa-home"></i> 老家：中国</li>
<li><i class="fa fa-info"></i> 爱好：睡觉、吃</li>
<li><i class="fa fa-birthday-cake"></i>建站时间：2018年8月26日</li>
<li><i class="fa fa-edit"></i> 简介：死猪不怕开水烫...</li></textarea>'));
    ...
    $link = new Typecho_Widget_Helper_Form_Element_Textarea('link', NULL, NULL, _t('友链HTML代码'), _t('如：&lt;a href="http://img.hostn.cn" target="_blank"&gt;云上博客&lt;/a&gt;'));
    $form->addInput($link);
