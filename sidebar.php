...
<div class="box-body">
	...
	<div class="huaji-half">
		<span class="icon-red"><i>LV.999</i></span>
	</div>
	<div class="clear"></div>
	<hr />
	<ul class="li-haf-border">
	<?php if ($this->options->selfidt): ?><?php $this->options->selfidt();else: ?>
	<li><i class="fa fa-thumbs-up"></i> 略略略略略略~ (๑•̀ㅂ•́)و✧</li>
	<li><i class="fa fa-home"></i> 家乡：中国</li>
	<li><i class="fa fa-info"></i> 爱好：睡觉、吃</li>
	<li><i class="fa fa-birthday-cake"></i> 建站时间：2018年8月26日</li>
	<li><i class="fa fa-edit"></i> 简介：死猪不怕开水烫...</li>
	<?php endif; ?>
	</ul>
</div>
</div>
...
<?php if (!empty($this->options->sidebarBlock) && in_array('my_reader', $this->options->sidebarBlock)): ?>
	...
	<div class="box-body">
		...
		<span title="我只是凑数的"><img class="avatar" data-original="//1.gravatar.com/avatar/5dd75e92f802b1ac87b2132542b32e1b?s=24&amp;d=&amp;r=G"></span><span title="我只是凑数的"><img class="avatar" data-original="//1.gravatar.com/avatar/d7a973c7dab26985da5f961be7b74480?s=24&amp;d=&amp;r=G"></span><span title="我只是凑数的"><img class="avatar" data-original="//1.gravatar.com/avatar/800db8558398890a3232e4ffbdbdda52?s=24&amp;d=&amp;r=G"></span><span title="我只是凑数的"><img class="avatar" data-original="//1.gravatar.com/avatar/144fbd313b60fdf0ba3136855b054ba4?s=24&amp;d=&amp;r=G"></span>
	    <div class="clear"></div>
	</div>
	</div>
<?php endif;
...
<?php endif; ?>
	...
	<div class="box-body tagsshow">
		<ul>
			<?php if ($this->options->link): ?><?php $this->options->link(); ?><?php else: echo '<a href="http://img.hostn.cn">云上博客</a>'; endif; ?>
		</ul>
		<div class="clear"></div>
	</div>
	</div>
