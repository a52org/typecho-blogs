...
?>
<!DOCTYPE HTML>
<html style="background-image: url(<?php if ($this->options->bgimg): ?><?php $this->options->bgimg();else: ?>https://img.hostn.cn/bj.jpeg<?php endif; ?>);">
<head>
...
<div class="body c-min">
	<div class="body-top-bg shadow" style="background-image: url(<?php if ($this->options->topimg): ?><?php $this->options->topimg(); ?><?php else: ?>//img.hostn.cn/head.jpg<?php endif; ?>);">
